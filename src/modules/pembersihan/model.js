...
function mapSensusDetailItem(sensus, detail) {
  ...
  return {
    ...
    jobType: detail?.type_of_work?.name || detail?.description || 'Pembersihan',
  ...
  return {
    ...
    getIntro() {
      return {
        ...
        description: 'Daftar sensus pembersihan kebun berdasarkan data lapangan.'
      }
    }
  }
}
