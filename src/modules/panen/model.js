...
export function createPanenModel() {
  return {
    getNavigation() {
    ...
    getIntro() {
      return {
        title: 'Penugasan Panen',
        description: 'Daftar sensus panen kebun berdasarkan data lapangan.'
      }
    }
  }
}

export async function loadPanenList(filters = {}) {
...
export async function loadPanenDetail(sensusId, detailId = null) {
