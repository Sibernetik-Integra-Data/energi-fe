<template>
  <div>
    ...
    <div class="flex justify-between items-center gap-4 mb-3">
      ...
      <div class="flex gap-2 bg-(--surface-muted) border border-(--border) p-1.5 rounded-full items-center shrink-0" role="tablist" aria-label="Sensus filters">
        <button
          ...
          >
            ...
            <td class="py-5 px-6 align-middle">
              <div class="flex gap-2.5 items-center">
                <button class="text-sm py-1.5 px-3 rounded-lg font-semibold text-(--text) bg-transparent border-0 hover:bg-(--surface-muted) transition-colors cursor-pointer">View</button>
    ...
    <div class="hidden gap-3 mt-3 max-[920px]:flex max-[920px]:flex-col">
      ...
      >
        ...
        <div class="flex justify-end gap-2">
          <button class="text-sm py-1.5 px-3 rounded-lg font-semibold text-(--text) border border-(--border) bg-(--surface) hover:bg-(--surface-muted) transition-colors cursor-pointer">View</button>
          <button class="text-sm py-1.5 px-4 rounded-lg border-0 bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors cursor-pointer">Verify</button>
        </div>
      </div>
    </div>
