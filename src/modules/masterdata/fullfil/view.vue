<template>
  <div class="h-screen flex bg-transparent max-[920px]:flex-col">
    ...
    <div class="flex-1 min-w-0 flex flex-col overflow-hidden">
      <BaseHeader eyebrow="Master Data" title="Fullfil" :notifications="0" :user="user" :on-logout="logoutFromKeycloak" />
      <main class="flex-1 min-w-0 p-6 overflow-y-auto max-[920px]:p-4.5"><FullfilList /></main>
    </div>
  </div>
</template>
...
import FullfilList from './components/FullfilList.vue'
